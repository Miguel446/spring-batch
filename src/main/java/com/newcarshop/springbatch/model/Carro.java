package com.newcarshop.springbatch.model;
...
import com.newcarshop.springbatch.enums.LojaEnum;
...
public class Carro implements Serializable {
	...
	public Carro(Long id, String renavam, String marca, String modelo, Integer anoFabricacao, Integer anoModelo,
			BigDecimal valorCompra, BigDecimal valorVenda, BigDecimal percentalMaxDesconto, LojaEnum loja,
			Date dataCadastro) {
		this.id = id;

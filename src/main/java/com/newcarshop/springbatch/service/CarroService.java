package com.newcarshop.springbatch.service;
...
import com.newcarshop.springbatch.utils.DateUtils;
...
public class CarroService {
	...
	public BatchStatus batchExecute() {
		...
		try {
			...
			LOGGER.error("Falha ao tentar executar JOB {}", e.getMessage());
